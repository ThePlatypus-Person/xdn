...
XDN_TEST_GIGAPAXOS_CONFIG="${XDN_TEST_GIGAPAXOS_CONFIG:-}"

EXTRA_JVM_ARGS=()
if [ -n "$XDN_TEST_GIGAPAXOS_CONFIG" ]; then
    EXTRA_JVM_ARGS+=("-DXDN_TEST_GIGAPAXOS_CONFIG=$XDN_TEST_GIGAPAXOS_CONFIG")
fi
