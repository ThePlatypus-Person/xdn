 ...
 * @param <NodeIDType>
 * @param <EventType>
 * @param <KeyType>    This abstract class is concretized for Long keys, int node IDs,
...
public abstract class ThresholdProtocolTask<NodeIDType, EventType, KeyType>
    ...
    /**
     * @param restartPeriod The period after which restart messages will be sent (only to
