...
public class InitBackupPacket extends PrimaryBackupPacket implements Byteable {
    ...
    public InitBackupPacket(String serviceName, String initialState) {
        this(Math.abs(UUID.randomUUID().getLeastSignificantBits()),
                serviceName,
                initialState);
    }

    private InitBackupPacket(long packetId, String serviceName, String initialState) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(serviceName, initialState);
    }
    ...
    public static InitBackupPacket createFromString(String encodedPacket) {
        ...
        try {
            ...
            String initialState = json.getString("initialState");

            return new InitBackupPacket(serviceName, initialState);
