 ...
 * @author arun
 */
public class ReconfigureActiveNodeConfig<NodeIDType> extends
     ...
     * @param sockAddr
     */
    public ReconfigureActiveNodeConfig(NodeIDType initiator, NodeIDType nodeID,
     ...
     * @param deletedNodes
     */
    public ReconfigureActiveNodeConfig(NodeIDType initiator,
                                       Map<NodeIDType, InetSocketAddress> newlyAddedNodes,
                                       Set<NodeIDType> deletedNodes) {
        super(initiator,
                ReconfigurationPacket.PacketType.RECONFIGURE_ACTIVE_NODE_CONFIG,
                newlyAddedNodes, deletedNodes);
    }
     ...
     */
    public ReconfigureActiveNodeConfig(JSONObject json,
