...
/**
 * @param <K>
 * @param <V> DiskMap implements the ConcurrentMap<K,V> interface and allows
...
public abstract class DiskMap<K, V> implements ConcurrentMap<K, V>,
    ...
    /**
     * @param inMemoryCapacity Capacity for in-memory map. If the in-memory map size reaches
