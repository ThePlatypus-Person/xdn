...
/**
 * @param <NodeIDType> Consider using JSONMessenger any place you want to use this class.
...
public class JSONNIOTransport<NodeIDType> extends
     ...
     *
     * @param id         My node ID.
     * @param nodeConfig A map from all nodes' IDs to their respective socket
     *                   addresses.
     * @throws IOException
     */
     ...
     * @param start      If a server thread must be automatically started upon
